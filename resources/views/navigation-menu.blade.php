        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8 ">
                    ...
                    <a href="#"
                        class="border-blue-500 text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        Dasbor </a>
                    <a href="#"
                        class="border-transparent text-gray-500 hover:border-blue-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        Cari </a>
                    <a href="#"
                        class="border-transparent text-gray-500 hover:border-blue-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        Lomba </a>
